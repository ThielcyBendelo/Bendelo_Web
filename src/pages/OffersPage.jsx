...
<div className="relative w-full z-10">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full mt-12 px-1 mb-24">
    {offers.map((offer) => (
      <motion.div
        key={offer.id}
        whileHover={{ y: -8 }}
        className={`group relative p-8 border transition-all duration-300 flex flex-col h-full rounded-none shadow-2xl w-full ${
          offer.popular
