...
export default function TechnologiesSection() {
  return (
    <section
      ...
      id="technologies"
    >
      <div className="max-w-5xl mx-auto text-center py-16 px-8 bg-gradient-to-b from-black via-black-50 to-blur-50">
          <MotionH2
            className="text-4xl font-extrabold font-bold bg-gradient-to-r from-[var(--accent-1)] to-[var(--accent-2)] text-transparent bg-clip-text "
        ...
        <div className="grid gap-8 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 py-16 px-8 bg-gradient-to-b from-black via-black-50 to-blur-50">
          {technologies.map((tech, idx) => (
            <MotionDiv
              key={tech.name}
              className="bg-black rounded-xl shadow-lg p-6 flex flex-col items-center border border-blue-100 hover:shadow-2xl transition"
              initial={{ opacity: 0, y: 40 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.3 }}
            ...
            >
              ...
              <h3 className="text-xl font-bold bg-gradient-to-r from-[var(--accent-1)] to-[var(--accent-2)] text-transparent bg-clip-text">{tech.name}</h3>
              <p className="text-gray-400 text-sm text-center mb-2 group-hover:text-gray-800 transition-colors">{tech.description}</p>
