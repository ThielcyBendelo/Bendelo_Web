...
>
  ...
  <div className="max-w-7xl mx-auto relative z-10 w-full">
    ...
    {/* --- GRILLE DE PROCESSUS RESPONSIVE --- */}
    <div className="relative w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12 px-1 w-full">
        {steps.map((step, idx) => (
          <motion.div 
            key={idx}
          ...
          >
            ...
            {/* Flèche de liaison minimaliste (Uniquement desktop large) */}
            {idx !== steps.length - 1 && (
