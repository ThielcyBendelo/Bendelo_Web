...
function FAQSection() {
  return (
    <section className="py-16 px-4 bg-gradient-to-b from-gray-50 via-white to-blue-50" id="faq">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-4xl font-extrabold text-blue-900 mb-6 drop-shadow-lg text-center">FAQ</h2>
        <p className="text-lg text-gray-700 mb-10 text-center">Questions fréquentes sur nos services et notre accompagnement.</p>
        <div className="space-y-6">
          {faqs.map((faq, idx) => (
            <details key={idx} className="bg-white rounded-xl shadow p-4 border border-blue-100">
              <summary className="font-semibold text-blue-800 cursor-pointer text-lg">{faq.question}</summary>
