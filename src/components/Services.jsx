...
<div className="relative w-full z-10">
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 px-1 w-full">
    {filteredServices.map((service, idx) => (
      <motion.div
        ...
        whileHover={{ y: -6 }}
        whileTap={{ scale: 0.99 }}
        className="group relative p-8 border border-white/10 bg-white/[0.02] backdrop-blur-xl transition-all duration-300 hover:border-[#FF6B35]/40 flex flex-col justify-between min-h-[520px] w-full rounded-none shadow-2xl"
      >
